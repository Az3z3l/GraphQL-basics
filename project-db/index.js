...
const typeDefs = gql`
    ...
    type Query {
        ...
        students: [Student]
        checker(user:String!,pwd:String!): String!
    }
...
const resolvers = {
    Query: {
        ...
        checker: async(root,args,context,info) => {

            const number = await pool.query('select * from users where username="'+args.user+'" and password="'+args.pwd+'";');
